...
public final class kk_defultPluginConnectionConfig {
    public static PluginConnectionsConfig GetDefaultConnectionsConfig()
    {
        ...
        Ret.Connections[0].PinName[0]=PluginConsts.KK_PLUGIN_BASE_PLUGIN_DEF_PIN_ODB2_DATA;
        Ret.Connections[0].PinName[1]=PluginConsts.KK_PLUGIN_BASE_PLUGIN_DEF_PIN_ODB2_RAW;
        //DataProcessor->ODB
        ...
        Ret.Connections[1].PinName[0]=PluginConsts.KK_PLUGIN_BASE_PLUGIN_DEF_PIN_ODB2_COMMAND;
        //DataProcessor->LED
        ...
        Ret.Connections[2].PinName[0]=PluginConsts.KK_PLUGIN_BASE_PLUGIN_DEF_PIN_LED_COMMAND;
        Ret.Connections[2].PinName[1]=PluginConsts.KK_PLUGIN_BASE_PLUGIN_DEF_PIN_LED_DATA;
         //LED->Data Processor
        ...
        Ret.Connections[3].PinName[0]=PluginConsts.KK_PLUGIN_BASE_PLUGIN_DEF_PIN_LED_DATA;
        return Ret;
